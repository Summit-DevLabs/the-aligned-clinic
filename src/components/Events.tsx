...
const events = [
  {
    ...
    imageUrl: 'https://images.unsplash.com/photo-1612830720303-4b3b3b3b3b3b',
    date: 'March 1, 2022',
    datetime: '7:00 PM',
      ...
      <div className="bg-white py-24 sm:py-32">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <p className="mt-4 text-lg tracking-tight text-slate-700">We host events to help you learn more about your health and wellness.</p>
          </div>
          <div className="mx-auto mt-16 grid max-w-2xl auto-rows-fr grid-cols-1 gap-8 sm:mt-20 lg:mx-0 lg:max-w-none lg:grid-cols-3">
            {events.map((events) => (
              ...
              >
                <img alt="" src={events.imageUrl} className="absolute inset-0 -z-10 h-full w-full object-cover" />
